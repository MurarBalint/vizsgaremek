...
function RouteComponent() {
    return (
        <DefaultUIFrame>
            <ScrollArea className="h-[calc(100vh-80px)] w-full p-14 bg-primary-50 text-gray-900">
                {/* Hero szekció */}
                <div className="flex flex-col items-center text-center gap-6 mb-12">
                    <h1 className="text-5xl font-bold text-primary-950">Rólunk – VizsgaRemek</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 max-w-6xl mx-auto">
                    ...
                    <Card className="bg-white shadow rounded-lg">
                        <CardHeader className="flex items-center gap-2">
                            <ImageIcon className="w-6 h-6 text-primary-900" />
                ...
                {/* Adatvédelem & GDPR */}
                <Card className="bg-primary-100 p-6 max-w-6xl mx-auto shadow rounded-lg mb-12">
                    <CardTitle className="text-primary-900">Adatvédelem & GDPR</CardTitle>
                    <CardDescription>
                    ...
                    <Button variant="link" className="mt-2 text-primary-900 underline">
                ...
                <Card className="bg-white p-6 max-w-6xl mx-auto shadow rounded-lg mb-20">
                    <CardTitle className="text-primary-900">Kapcsolat</CardTitle>
                    <CardDescription>
                        Ha kérdésed van, írj nekünk e-mailt: <a href="mailto:Hartwigmatos@gmail.com" className="underline text-primary-900">Hartwigmatos@gmail.com</a> vagy <a href="mailto:murarbalint688@gmail.com" className="underline text-primary-900">murarbalint688@gmail.com</a>
                    </CardDescription>
                </Card>
            </ScrollArea>
