...
function RouteComponent() {
    return (
        <DefaultUIFrame>
            <div className="flex flex-col items-center w-full h-full p-10 bg-primary-50 text-gray-900 gap-10">
                <h1 className="text-5xl font-bold text-primary-950 mb-6">Adatvédelmi irányelvek</h1>
                ...
                <ScrollArea className="w-full max-w-5xl h-[600px] bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">1. Adatgyűjtés</h2>
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">2. Cookie-k és nyomkövetés</h2>
                            <p className="text-gray-700">
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">3. Adatkezelés és tárolás</h2>
                            <p className="text-gray-700">
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">4. Felhasználói jogok</h2>
                            <p className="text-gray-700">
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">5. Adatbiztonság</h2>
                            <p className="text-gray-700">
                        ...
                        {/* Szekció: Kapcsolat */}
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">6. Kapcsolat</h2>
                            <p className="text-gray-700">
                        ...
                        {/* Szekció: Módosítások */}
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold text-primary-900">7. Irányelvek módosítása</h2>
                            <p className="text-gray-700">
