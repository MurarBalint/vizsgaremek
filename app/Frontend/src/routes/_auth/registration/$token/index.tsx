...
function RouteComponent() {
  ...
  if (data?.status == 200) {
    return (
      <div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10 bg-gradient-to-b from-primary-900 to-slate-400">
        <div className="w-full max-w-sm bg-slate-100 p-6 rounded-4xl">
          <div className="flex items-center gap-2 font-medium">
            <div className="bg-accent-600 text-primary-foreground flex size-6 items-center justify-center rounded-md">
