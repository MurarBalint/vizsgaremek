 ...
 *         $ref: '#/components/responses/BadRequest'
 */
router.post("/", [authMiddleware.userIsLoggedIn, upload.single("media"), cloudMiddleware.Req_HasFile, normalizeUploadedImage], user_postController.createUser_Post);
 ...
 *         $ref: '#/components/responses/BadRequest'
 */
router.patch("/:postId", [authMiddleware.userIsLoggedIn, upload.single("media"), cloudMiddleware.Req_HasFile, normalizeUploadedImage], user_postController.updateUser_Post);
